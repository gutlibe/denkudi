            ...
            <div className="flex min-h-screen flex-col bg-background">
                ...
                <main className="flex-1">
                    <section className="relative overflow-hidden border-b">
                        <div className="mx-auto max-w-6xl px-6 pt-20 pb-20 sm:pt-28 lg:pt-36">
                            <div className="mx-auto max-w-3xl text-center">
                                ...
                                <p className="mx-auto mt-6 max-w-xl text-lg text-pretty text-muted-foreground">
                                    Cast your vote from anywhere. Fast,
                                    transparent, and built for HTU students — no
                                    email, just your student ID.
                                </p>
                    ...
                    <section className="py-24 sm:py-32">
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="mx-auto max-w-3xl text-center">
                                ...
                                <p className="mt-4 text-muted-foreground">
                                    Join HTU students in shaping campus
                                    leadership. It takes less than a minute.
                                </p>
                                {!isLoggedIn && (
