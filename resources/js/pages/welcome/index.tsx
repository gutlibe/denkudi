...
import { ArrowRight02Icon, CheckmarkCircle01Icon, Analytics01Icon, AiSecurity01Icon, Calendar01Icon } from '@hugeicons/core-free-icons';
                ...
                <header className="sticky top-0 z-50 hidden border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 lg:flex">
                    <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-6">
                        <Link href="/" className="flex items-center gap-2.5">
                            ...
                            <span className="font-semibold tracking-tight hidden sm:inline">HTU E-Voting</span>
                        </Link>
                        ...
                        <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28 lg:py-36">
                            <div className="mx-auto max-w-3xl text-center">
                                ...
                                <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
                                    Cast your vote from anywhere. For student elections, referendums, department polls, and more — no email, just your student ID.
                                </p>
                                {!isLoggedIn && (
                                    <div className="mt-8 flex items-center justify-center gap-3">
                                        <Button asChild size="lg"><Link href={register()}>Get Started <HugeiconsIcon icon={ArrowRight02Icon} size={16} className="ml-1.5" /></Link></Button>
                    ...
                    <section className="py-16 sm:py-24">
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="mx-auto max-w-2xl text-center mb-12">
                                ...
                                <p className="mt-3 text-muted-foreground">Three simple steps to make your voice heard.</p>
                            </div>

                            <div className="grid gap-8 lg:grid-cols-3">
                                {/* Step 1: Register */}
                                <Card className="relative overflow-hidden">
                                    <span className="absolute top-3 right-4 text-6xl font-bold text-muted-foreground/10">01</span>
                                    <CardHeader>
                                    ...
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground mb-4">Sign up with your 10-digit student ID. No email needed.</p>
                                        <div className="rounded-lg border bg-card p-3 space-y-2 opacity-70">
                                ...
                                <Card className="relative overflow-hidden border-primary/30 bg-primary/[0.02]">
                                    <span className="absolute top-3 right-4 text-6xl font-bold text-muted-foreground/10">02</span>
                                    <CardHeader>
                                    ...
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground mb-4">Select candidates, review your ballot, and submit securely.</p>
                                        <div className="rounded-lg border border-primary/20 bg-background p-3 space-y-1.5">
                                            <div className="text-xs text-muted-foreground mb-1">President</div>
                                ...
                                {/* Step 3: Results */}
                                <Card className="relative overflow-hidden">
                                    <span className="absolute top-3 right-4 text-6xl font-bold text-muted-foreground/10">03</span>
                                    <CardHeader>
                                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary mb-2">
                                    ...
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground mb-4">View live results with charts and verify your vote.</p>
                                        <div className="rounded-lg border bg-card p-3 space-y-2 opacity-70">
                                            <div className="flex items-center gap-2 text-xs">
                                                <span className="h-3 w-16 rounded bg-primary/40" />
                                                <span className="h-3 w-8 rounded bg-muted ml-auto" />
                                            </div>
                                            <div className="space-y-1.5">
                                                <div className="flex items-center gap-2">
                                                    <div className="h-2 flex-1 rounded-full bg-primary/60" />
                                                    <span className="text-[10px] text-muted-foreground w-8 text-right">42%</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <div className="h-2 flex-1 rounded-full bg-muted" />
                                                    <span className="text-[10px] text-muted-foreground w-8 text-right">33%</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <div className="h-2 flex-1 rounded-full bg-muted" />
                                                    <span className="text-[10px] text-muted-foreground w-8 text-right">25%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </CardContent>
                    ...
                    <section className="py-12 sm:py-16">
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
                                <div className="flex items-center gap-2"><HugeiconsIcon icon={AiSecurity01Icon} size={16} className="text-primary" /><span>Anonymous voting</span></div>
                                <span className="hidden sm:inline text-border">|</span>
                                <div className="flex items-center gap-2"><HugeiconsIcon icon={CheckmarkCircle01Icon} size={16} className="text-primary" /><span>Chain verified</span></div>
                                <span className="hidden sm:inline text-border">|</span>
                                <div className="flex items-center gap-2"><HugeiconsIcon icon={Calendar01Icon} size={16} className="text-primary" /><span>Live results</span></div>
                            </div>
                        </div>
                    </section>
                </main>
